...
class CalculadoraIVAISR:
    def __init__(self, ventana):
        ...
        self.boton_copiar = tk.Button(ventana, text="Copiar IVA e ISR", font=("Century Gothic", 12, "bold"), bg="#87CEEB", fg="#FFFFFF", command=self.copiar_resultado)
    ...
    def copiar_resultado(self):
        iva_text = self.etiqueta_iva.cget("text")
        iva_value = iva_text.split(": ")[1]
        self.ventana.clipboard_clear()
        self.ventana.clipboard_append(iva_value)
